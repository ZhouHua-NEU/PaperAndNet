...
#model
parser.add_argument('--model_name', default='ZFnet', type=str)
...
parser.add_argument('--batchsize', default=16, type=int,metavar='N', help='batch size ')
...
#定义网络并进行训练
net = ZFNet(args.numclass).to(device)
