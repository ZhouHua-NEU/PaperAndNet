...
parser.add_argument('--model_layers',default=18,type=int,choices=[18,34,50,101,152])
...
#定义网络并进行训练
net = resnet(args.model_layers)
#net = torch.load(args.model_loadpath,map_location=device)
from torchinfo import summary
with open("model/resnet%s_summary.txt"%args.model_layers, "w", encoding='utf-8') as f:
