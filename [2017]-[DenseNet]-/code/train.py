...
parser.add_argument('--model_layers',default=201,type=int,choices=[121,161,169,201])

#optimiter
parser.add_argument('--epochs', default=2, type=int, metavar='N',help='number of total epochs to run')
parser.add_argument('--batchsize', default=1, type=int,metavar='N', help='batch size')
...
#定义网络并进行训练
net = densenet(args.model_layers,args.numclass)
#net = torch.load(args.model_loadpath,map_location=device)
from torchinfo import summary
with open("model/%s%s_summary.txt"%(args.model_name,args.model_layers), "w", encoding='utf-8') as f:
